...
Public Function Replace(sSrc As String, sTerm As String, sNewTerm As String, Optional lStart As Long = 1, Optional lHitCnt As Long, Optional ByVal lCompare As VbCompareMethod = vbBinaryCompare) As String
    On Error Resume Next
    Dim lSize As Long
    Dim lHit As Long
    Dim lHitPos As Long
    Dim lPos As Long
    Dim lLenOrig As Long
    Dim lOffset As Long
